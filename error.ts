...
/**
 * This class provides a wrapper for network errors when making requests to The Jina Embedding Serving API
 */
export class JinaAiError extends Error {
  /**
   * The response body
   */
